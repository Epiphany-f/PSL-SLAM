...
#include "add_inc/auxiliar.h"
#include "add_inc/MapLine.h"
#include "add_inc/LSDmatcher.h"
#include "add_inc/insectline.h"
#include "add_inc/InsectlineMatch.h"
#include <mutex>
...
protected:
    ...
    std::vector<InsectLine*> mvpLocalMapInsecs;
