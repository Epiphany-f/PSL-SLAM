...
public:
    ...
    //add
    void AddInsec(InsectLine *pMP, const size_t &idx);
    void EraseMapinsecMatch(const int &idx);
    void EraseMapinsecMatch(InsectLine *pinsec);
    void ReplaceMapinsecMatch(const size_t &idx, InsectLine* pMP);
    vector<InsectLine*> GetMapInsecsMatches();
    //add
    void AddMapInsec(ORB_SLAM2::InsectLine* pInsec, const size_t& idx);
